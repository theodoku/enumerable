...
- provides a set of methods that allow objects to be iterated and processed
- sorts, finds, and groups elements.
...
```sh
  git https://github.com/theodoku/enumerable.git
  cd enumerable
```
...
Feel free to check the [issues page](https://github.com/theodoku/enumerable/issues).
